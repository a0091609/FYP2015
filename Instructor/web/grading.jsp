        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row-fluid">
                        <div class="span12 no-more-tables">
                            <table class="table table-striped table-bordered table-hover table-condensed cf" id="sample_3">
                                ...
                                <td data-title="Actions"><center><a data-toggle="modal" href="#responsive" class="btn green"><i class="icon-ok"></i> Grade</a></center></td>
                                </tr>
                                <tr class="gradeX">
                    ...
                    <!-- MODAL WINDOW -->
                    <form action="grading2.jsp" method="post">
